...
public:
	...
	Empleado(int idemp, string nom, string ape, string dir, int tel, string cui, int gen, string mail, string fn, string fil, string fi) : Persona_E(nom, ape, dir, tel, cui, gen, fn, fil, fi) {
		id_empleado = idemp;
	}
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			string insert = "INSERT INTO `proyecto final super mercado`.empleados (nombres,apellidos,direccion,telefono,DPI,genero,fecha_Nacimiento,idPuesto,fecha_inicio_labores,fechaingreso)VALUES('" + nombre + "','" + apellido + "','" + direccion + "'," + t + ",'" + DPI + "'," + g + ",'" + fecha_nacimiento + "','" + /*idPuesto*/ + "','" + fecha_inicio_labores + "','" + fechaingreso + "');";
	...
	void modificar() {
		...
		if (cn.getConectar()) {
			...
			string t = to_string(telefono);
			string g = to_string(genero);
			string actualizar = "UPDATE estudiantes.estudiantes SET nombres='" + nombre + "',apellidos='" + apellido + "',direccion='" + direccion + "',telefono = " + t + ",DPI='" + DPI + "',genero=" + g + ",fecha_nacimiento='" + fecha_nacimiento + "',idPuesto='" + /*idPuesto*/ + "',fecha_incio_labores='" + fecha_inicio_labores + "',fechaingreso='" + fechaingreso + "',  WHERE idEmpleado =" + id + ";";
